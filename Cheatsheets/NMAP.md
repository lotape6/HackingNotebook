# Simple quick enumeration
```
sudo nmap -sS --min-rate 5000 -vvv -n -p- -Pn <IP> -oN nmap.out

# If nothing is printed, you could try also scanning UPD ports
sudo nmap --min-rate 5000 -T -vvv -n -p- -Pn <IP> -oN nmap.out
...
nmap -p$ports -sC -sV <IP> -oN detailed.nmap.out
```
